...
const TOOL_DEFS = [
  ...
  { id: Tool.SPLINE,   icon: '⌇', labelKey: 'spline',   key: 'SPL' },
  { id: Tool.POLYGON,  icon: '⬡', labelKey: 'polygon',  key: 'POL' },
  { id: Tool.REVCLOUD, icon: '☁', labelKey: 'revcloud', key: 'RVC' },
  { id: Tool.WIPEOUT,  icon: '▰', labelKey: 'wipeout',  key: 'WI' },
  { id: Tool.DONUT,    icon: '◍', labelKey: 'donut',    key: 'DO' },
  { id: Tool.XLINE,    icon: '⋯', labelKey: 'xline',    key: 'XL' },
